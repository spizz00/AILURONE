...
public sealed class SpikeBlockDeletionPreviewHarness : MonoBehaviour
{
    public SpikeBlockDeletionPreviewController controller;
    ...
    public void PlayIndex(int index)
    {
        ...
        SpikeBlockDeletionPreviewController.PreviewMode mode = index < 2
            ? SpikeBlockDeletionPreviewController.PreviewMode.Hipfire
            : index < 4
                ? SpikeBlockDeletionPreviewController.PreviewMode.Ads
                : SpikeBlockDeletionPreviewController.PreviewMode.Kill;
    ...
    private void OnGUI()
    {
        ...
        GUI.Label(new Rect(30, 26, width - 28, 24), "AILURONE — BLOCK DELETION HIT FX V5");
        ...
        GUI.Label(new Rect(30, 169, width - 28, 20), "Preview only — formal game systems remain unchanged.");
    }
}
